        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <a href="novosibirsk.php" class="btn btn-primary">Подробнее</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <a href="kazan.php" class="btn btn-primary">Подробнее</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <a href="mozhaisk.php" class="btn btn-primary">Подробнее</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <a href="voronezh.php" class="btn btn-primary">Подробнее</a>
                </div>
            </div>
        </div>
    </div>
